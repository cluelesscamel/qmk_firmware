...
//remove deprecated features to reduce firmware size
...
#define OLED_FONT_H "keyboards/crkbd/keymaps/_endgame/glcdfont.c"

//sleep rgb when host sleeps
...
//#   define RGB_MATRIX_SPLIT { 27, 27 } // reacts to keypresses
